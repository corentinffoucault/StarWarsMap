...
// UMD module definition
        ...
        SvgPanZoom.prototype.centerAt = function(scale, point, absolute) {
            var svgCenter = { x: this.width/2, y: this.height/2 },
                offsetX = svgCenter.x - point.x * this.getZoom(),
                offsetY = svgCenter.y - point.y * this.getZoom();
            this.getPublicInstance().pan({ x: offsetX, y: offsetY });
            this.zoom(scale, absolute);
        };
        ...
        SvgPanZoom.prototype.getPublicInstance = function() {
            ...
            if (!this.publicInstance) {
                this.publicInstance = this.pi = {
                    ...
                    centerAt: function(scale, point, absolute) {
                        return that.centerAt(scale, point, absolute);
                    },
                    zoomIn: function() {
