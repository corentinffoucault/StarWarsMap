...
(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
        ...
        ShadowViewport.prototype.getViewport = function() {
...
// UMD module definition
        ...
        SvgPanZoom.prototype.center = function() {
            ...
            console.log("############offsetX##############")
            console.log(JSON.stringify(offsetX, null, 2))
            console.log(JSON.stringify(offsetY, null, 2))
            console.log("##########################")
            this.getPublicInstance().pan({ x: offsetX, y: offsetY });
        };

        SvgPanZoom.prototype.centerAt = function(point) {
            var viewBox = this.viewport.getViewBox(),
                offsetX_ori = (this.width - (viewBox.width + viewBox.x * 2) * this.getZoom()) * 0.5,
                offsetY_ori = (this.height - (viewBox.height + viewBox.y * 2) * this.getZoom()) * 0.5,
                offsetX = offsetX_ori-((point.x-viewBox.width/2) * this.getZoom()),
                offsetY = offsetY_ori-((point.y-viewBox.height/2) * this.getZoom());
